...
import it.kytech.launchercore.restful.InternalUpdateConstants;
...
public class LauncherInfo {
    ...
    public static int getLatestBuild(String stream) throws RestfulAPIException {
        LauncherBuild result = RestObject.getRestObject(LauncherBuild.class, InternalUpdateConstants.API + "/version/" + stream);
    ...
    public static String getDownloadURL(int version, boolean isJar) throws RestfulAPIException {
        ...
        String url = InternalUpdateConstants.API + "/url/" + version + "/" + ext;
